...
model_youth = joblib.load(ARTIFACTS_DIR / "model_youth.joblib")
scaler_youth = joblib.load(ARTIFACTS_DIR / "scaler_youth.joblib")
model_adults = joblib.load(ARTIFACTS_DIR / "model_adults.joblib")
scaler_adults = joblib.load(ARTIFACTS_DIR / "scaler_adults.joblib")
...
def predict(input_dict):
    ...
    if input_dict['Age'] <= 25:
        ...
        prediction = model_adults.predict(input_df)
